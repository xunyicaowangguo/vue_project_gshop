<template>
  <div class="msite_shop_list">
    ...
    <div class="shop_container">
      <ul class="shop_list">
        <li @click="goShop" class="shop_li border-1px" v-for="(shopItem,index) in shopList" :key="index">
          <a>
            <div class="shop_left">
            ...
            <div class="shop_right">
              <section class="shop_detail_header">
                ...
                <ul class="shop_detail_ul" >
                  <li class="supports" v-for="(support,index) in shopItem.supports" :key="index">{{support.icon_name}}</li>
                </ul>
             </section>
              <section class="shop_rating_order">
                <section class="shop_rating_order_left">
                  <Stars :rating="shopItem.rating"/>
                  <div class="rating_section">{{shopItem.rating}}</div>
                  <div class="order_section">月售 {{shopItem.recent_order_num}} 单</div>
                </section>
