<template>
  <div>
      <div class="shopcart">
        <div class="content2">
          <div class="content-left">
            <div class="logo-wrapper" @click="totalCount&&(isShowCart=!isShowCart)">
      ...
      <div class="list-mask" v-show="isShowCart" @click="isShowCart=false"></div>
  </div>
</template>
...
<script>
    ...
    import {CLEAR_CARTSHOPS} from '../../store/mutations_types'
  export default {
      ...
      computed:{
          ...
          payContent(){
              ...
              if(totalPrice === 0){
                  ...
                  text = `差${info.minPrice - totalPrice}元起送`
              }else{
                  text = `去结算`
              }
              return text
      ...
      methods:{
          clearCart(){
              MessageBox.confirm('确认清空吗？')
                .then(
                    actionAgreen => this.$store.commit(CLEAR_CARTSHOPS),
